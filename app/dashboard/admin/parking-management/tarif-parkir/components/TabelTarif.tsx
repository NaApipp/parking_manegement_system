...
export default function TabelTarif() {
  ...
  // HandleEdit
  const handleEdit = (id_tarif: number) => {
    router.push(`/dashboard/admin/parking-management/tarif-parkir/${id_tarif}`);
  };

  // HandleDelete
  const handleDelete = async (id_tarif: number) => {
                ...
                users.map((user, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-sm text-gray-600 dark:text-zinc-400">
                      {user.tarif_per_jam} Ribu Rupiah
                    </td>
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <button
                          onClick={() => handleEdit(user.id_tarif)}
                        ...
                        <button
                          onClick={() => handleDelete(user.id_tarif)}
